    ...
    <SeoLandingPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Express shipping via DHL or FedEx takes 7–10 business days from our Jaipur factory to Kuwait. Economy shipping via India Post EMS takes 20–30 days. We recommend DHL for time-sensitive orders and Eid/wedding season shipments.",
        },
        {
