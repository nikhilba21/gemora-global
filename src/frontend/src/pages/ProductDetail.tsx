...
export default function ProductDetail() {
  return (
    <SeoLandingPage
      title="Premium Wholesale Jewelry Product Detail | Jaipur Factory"
      metaDescription="Premium wholesale jewelry direct from factory. MOQ 50 units. Exporting to Global B2B Sourcing and worldwide."
      canonical="https://www.gemoraglobal.co/product-detail"
      h1="Premium Wholesale Jewelry Product Detail | Jaipur Factory"
      targetKeyword="wholesale jewelry product details"
      heroSubtitle="Direct wholesale exporter of premium jewelry from Jaipur. Safe heavy metal limits, complete custom clearances, and fast air freight to Global B2B Sourcing."
      hreflangs={EXPORT_HREFLANG_CLUSTER}
      breadcrumbs={[
        { name: "Home", url: "https://www.gemoraglobal.co/" },
        { name: "Wholesale", url: "https://www.gemoraglobal.co/wholesale" },
        { name: "Global B2B Sourcing", url: "https://www.gemoraglobal.co/product-detail" }
      ]}
      faqs={[
        {
        ...
        {
          q: "How long does shipping from Jaipur to Global B2B Sourcing take?",
