...
export default function PrivateLabelJewelleryIndia() {
  return (
    <SeoLandingPage
      title="Private Label Jewellery India | Gemora Global"
      metaDescription="Private label jewellery manufacturer India. Custom designs with your brand name, logo packaging. MOQ 500 units, 3-4 weeks. Trusted by brands worldwide."
      ...
      faqs={[
        {
          ...
          a: "Minimum order for private label is 500 units per design. This covers design development, sample production, branded packaging, and initial production.",
        },
        {
          q: "How long does private label production take?",
          a: "Total lead time from brief to delivered product is 5–7 weeks — 1–2 weeks for sample approval and 3–4 weeks for production. Reorders of approved designs take 3–4 weeks.",
        },
        {
          q: "Can I have my logo on the jewellery packaging?",
          a: "Yes. Branded packaging with your logo is a standard part of our private label service — boxes, pouches, hangtags, and certificates of authenticity can all carry your brand.",
        },
        {
          q: "Will my private label designs be sold to other buyers?",
          a: "No. Your private label designs are exclusive to you and are not produced for any other buyer. This exclusivity is documented in your private label agreement.",
        },
        {
