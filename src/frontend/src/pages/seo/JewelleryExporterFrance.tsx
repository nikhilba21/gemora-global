...
export default function JewelleryExporterFrance() {
  return (
    <SeoLandingPage
      ...
      faqs={[
        {
          q: "Can Gemora Global export jewellery directly to France?",
          a: "Yes. Gemora Global ships wholesale imitation jewellery directly to France via DHL, FedEx, and India Post EMS. We provide all required export documentation including commercial invoice, packing list, Certificate of Origin, and GST-compliant export invoice for smooth EU customs clearance.",
        },
        {
          q: "What is the minimum order quantity (MOQ) for French buyers?",
          a: "Our standard MOQ is 50 units per design for French buyers. Mixed designs are welcome across a single order. For custom OEM or private label orders, the MOQ is 500 units with a 3–4 week lead time.",
        },
        {
          q: "Are your jewellery pieces compliant with EU regulations for France?",
          a: "Our imitation jewellery uses nickel-free plating processes and anti-tarnish coating. We advise French buyers to review EU Directive 94/27/EC on nickel release with their compliance team. We can provide material declarations on request.",
        },
        {
          q: "How long does shipping to France take?",
          a: "Express shipping via DHL or FedEx takes 5–8 business days from our Jaipur factory to France. Economy shipping via India Post EMS takes 15–25 days. We recommend DHL for time-sensitive orders.",
        },
        {
          q: "Do you accept payments in Euros?",
          a: "We accept international wire transfers (T/T) in USD, EUR, and GBP. Payment terms are typically 50% advance and 50% before dispatch for new buyers, or 30-day credit terms for established accounts.",
        },
      ]}
      schema={{
