  ...
  return (
    <SeoLandingPage
      ...
      breadcrumbs={[
        ...
        { name: "Global Bohemian Fashion", url: "https://www.gemoraglobal.co/oxidised-jewellery-supplier" }
      ]}
      faqs={[
        {
        ...
        {
          q: "How long does shipping from Jaipur to Global Bohemian Fashion take?",
...
<h2 className="text-xl font-serif font-bold text-primary mt-0">
          ...
          <h2 className="text-xl font-serif font-bold text-primary">
            Jaipur to Global Bohemian Fashion: Door-to-Door Air Freight Corridor
          </h2>
          <p>
