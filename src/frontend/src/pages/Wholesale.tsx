...
export default function Wholesale() {
  return (
    <SeoLandingPage
      title="B2B Wholesale Imitation Jewellery Supplier India | Gemora Global"
      metaDescription="Premium wholesale jewelry direct from factory. MOQ 50 units. Exporting to Global B2B Wholesale and worldwide."
      canonical="https://www.gemoraglobal.co/wholesale"
      h1="B2B Wholesale Imitation Jewellery Supplier India | Gemora Global"
      targetKeyword="wholesale imitation jewellery supplier"
      heroSubtitle="Direct wholesale exporter of premium jewelry from Jaipur. Safe heavy metal limits, complete custom clearances, and fast air freight to Global B2B Wholesale."
      hreflangs={EXPORT_HREFLANG_CLUSTER}
      breadcrumbs={[
        { name: "Home", url: "https://www.gemoraglobal.co/" },
        { name: "Wholesale", url: "https://www.gemoraglobal.co/wholesale" },
        { name: "Global B2B Wholesale", url: "https://www.gemoraglobal.co/wholesale" }
      ]}
      faqs={[
        {
        ...
        {
          q: "How long does shipping from Jaipur to Global B2B Wholesale take?",
